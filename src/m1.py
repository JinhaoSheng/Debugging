...
#     You will see that the code "breaks" and p led to the exception
#       -- an error message that attempts torints on the Console:
#       -- a STACK TRACEBACK of the code that explain the exception
